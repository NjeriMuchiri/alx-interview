...
"""Algorithm of a prime game"""


def is_prime(n):
    """ Method that Checks if a number given n is a prime number """
...
def calculate_primes(n, primes):
    """ Method that Calculate all primes """
    top_prime = primes[-1]
    if n > top_prime:
...
def isWinner(x, nums):
    """
    Method where x is the number of rounds and nums is an array of n
